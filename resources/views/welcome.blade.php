...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <nav class="navbar" style="margin: 0;">
        <div class="container-fluid">
            <div class="navbar-header">
                <div class="box-logo">
                    <a href="index.html"><img src={{url('images/karismalogo.png')}} width="120" alt="Logo"></a>
                </div>
            </div>
            <ul class="nav navbar-nav navbar-right box-logo1" style="margin-right: 30px;">
                <li class="active" ><a href="#" style="height: 100%">Tentang Kami</a></li>
                <li><a href="#">Group Kami</a></li>
    ...
    <div>
        ...
        <section class="box-intro">
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="{{asset('images/01.jpg')}}" alt="Lingkungan" style="width:100%;">
                        <div>
                            <h1 id="message_header">ECO WASTE</h1>
                            <h3 id="message_text_detail" style="">
                                Berwawasan lingkungan untuk Indoesia yang lebih baik
                            </h3>
                        </div>
                    </div>

                    <div class="item">
                        <img src="{{asset('images/02.jpg')}}" alt="Dewan Komisaris" style="width:100%;">
                        <div>
                            <h1 id="message_header">PROFESIONALISME</h1>
                            <h3 id="message_text_detail" style="">
                                Kualitas adalah yang terdepan
                            </h3>
                        </div>
                    </div>

                    <div class="item">
                        <img src="{{asset('images/03.jpg')}}" alt="Tim Kerja" style="width:100%;">
                            <div>
                                <h1 id="message_header">ADVISORY</h1>
                                <h3 id="message_text_detail" style="">
                                    Kami hadir dengan keunggulan dan profesionalisme
                                </h3>
                            </div>
                    </div>
                </div>
            ...
            <div class="row" style="background: black; height: 100px">
                ...
                <div class="col-md-6">
                    ...
                    <a href="contact.html"  id="tombol-kembali" style="padding: 10px; margin-right: 10px;">Hubungi Kami</a>
                    <a href="groupkami.html"  id="tombol-kembali" style="padding: 10px">Produk Karisma.Inc</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div id="Kartika" class="tabcontent">
                                ...
                                <ul style="list-style: none; padding-left: 0px; color: black">
                                    <li>
        ...
        <div class="row" style="margin-bottom: 30px;">
            <section>
                ...
                <div class="col-sm-5 col-sm-offset-2 col-md-7 col-md-offset-1">
                    ...
                    <small><a href="about.html"><i class="ion-ios-plus-outline"> </i> baca lebih lanjut </a></small>
                </div>
        ...
        <footer>
            <div class="container-fluid">
                <p class="copyright" style="color: black">© Karisma.Inc 2018</p>
            </div>
        </footer>
        <!-- end footer -->
