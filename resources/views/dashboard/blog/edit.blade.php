...
<div class="container">
    ...
    <form action="{{route('blog.update',$blog->slug)}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="judul" placeholder="Judul blog" class="form-control" value="{{$blog->judul}}">
        </div>

        <div class="form-group">
            <label for="">Isi Blog</label>
            <textarea name="content"  class="form-control" id="summernote">{{$blog->content}}</textarea>
        </div>
